...
def attack(char_name: str, char_class: str) -> str:
    """Рандомно вычисляет какой урон вы нанесете."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рандомно вычисляет сколько вы заблокируете урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет ваш урон спец приемом."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Расказывает о вашем классе,а так же о навыках."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Создает никнейм и дает выбор класса героя."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """Дает выбрать класс,а так же показывает твои статы."""
